...
function filepanel (localRegistry) {
  ...
  function copyFiles () {
    modalDialogCustom.prompt(null, 'To which other remix-ide instance do you want to copy over all files?', 'https://shyftnetwork.github.io/shyft_remix-ide/', (target) => {
      doCopy(target)
    })
