...
echo "Built website from \`$SHA\`. See https://github.com/shyftnetwork/remix-ide/ for details." >> README.md
...
git push -f git@github.com:shyftnetwork/remix-live-alpha.git gh-pages
